...
**Use only these six terms throughout all sections of this module and all sections of every report. Use the same amounts consistently — any mismatch between the negotiation table, price-tier ranking tables, and final recommendation is a blocking audit failure.**
...
| **Target settlement** | Desired likely landing price; this is where you hope the deal closes | Section C, price-tier Table B |
| **Stretch maximum** | Highest price you may accept if all due diligence is clean and competition is real | Section C, price-tier Table D |
...
- Do NOT call a low opening bid a "walk-away price" — a low opening bid is the "opening offer" or "aggressive buyer-case price"
- Do NOT label the stretch maximum the same as the walk-away ceiling unless they are genuinely identical
- Walk-away ceiling >= stretch maximum >= target settlement >= opening offer (if this ordering fails, recheck your numbers)
- "Aggressive buyer-case" is a scenario for analysis — it is not a recommendation to bid at that level
...
|-------|--------|-----------|-----------------|--------------------------|
| **Opening offer** | EUR X,XXX,XXX | -X% | [specific model threshold e.g. base CF > EUR0] | Low / Medium / High |
| **Target settlement** | EUR X,XXX,XXX | -X% | [where combined downside CF >= EUR0] | Low / Medium / High |
| **Stretch maximum** | EUR X,XXX,XXX | -X% | [max acceptable if all DD clean] | Low / Medium / High |
| **Walk-away ceiling** | EUR X,XXX,XXX | -X% | [combined stress negative above this; do not exceed] | n/a |

*Note: An **aggressive buyer-case price** (lower than opening offer, to show upside if a tough bid succeeds) may be shown separately in price-tier Table C. It is a scenario, not a recommendation.*
...
Every multi-property report must include all four tables. Use the terminology glossary terms consistently — do not rename or merge these tables.

### Table A: Ranking at Asking Price

| Rank | Property | Asking | CF/mo (30%) | Eco ROI | S9 CF | Resilience |
|------|----------|:------:|:-----------:|:-------:|:-----:|:----------:|

### Table B: Ranking at Target Settlement

*Recalculate mortgage, monthly payment, CF, Eco ROI, and S9 CF at each property's target settlement price. Show rank change vs. Table A.*

| Rank | Property | Target Settlement | CF/mo (30%) | Eco ROI | S9 CF | vs. Asking CF | Rank change |
|------|----------|:-----------------:|:-----------:|:-------:|:-----:|:-------------:|:-----------:|

### Table C: Ranking at Aggressive Buyer-Case Price

*Show deal metrics if a tough low offer succeeds. This is a scenario analysis, not a recommendation. Label clearly: "Aggressive buyer-case — not the expected outcome."*

| Rank | Property | Aggressive Price | CF/mo (30%) | Eco ROI | S9 CF | Prob. of acceptance |
|------|----------|:----------------:|:-----------:|:-------:|:-----:|:-------------------:|

### Table D: Ranking at Walk-Away Ceiling (Maximum Acceptable)

*The highest price you should pay for each property. Above this, do not proceed.*

| Rank | Property | Walk-Away Ceiling | CF/mo (30%) | Eco ROI | S9 CF | Note |
|------|----------|:-----------------:|:-----------:|:-------:|:-----:|------|

**For each table where price changes the ranking vs. asking: highlight the rank change explicitly.**

For each property where moving from Table A to Table B (i.e., negotiating to target) changes the verdict (e.g., Marginal → Possible Buy, or Weak → Thin but positive): state this explicitly in a single sentence below the table.

---

## Terminology Consistency Check

Before finalising the negotiation section, verify:

- [ ] The opening offer in Section C matches Table A (or is clearly lower for the aggressive case)
- [ ] The target settlement in Section C matches Table B
- [ ] The stretch maximum in Section C matches Table D (walk-away ceiling) or is clearly explained as different
- [ ] The aggressive buyer-case in Table C is clearly labelled as a scenario, not a recommendation
- [ ] All amounts are rounded to nearest EUR500 or EUR1,000
- [ ] No table uses "stretch" as a synonym for "walk-away" — these are distinct
- [ ] The same amounts appear in the negotiation table (Section C), the price-tier tables (A/B/C/D), and the Final Recommendation section

**If numbers are inconsistent across these sections, it is a blocking audit failure (Check 12).**
